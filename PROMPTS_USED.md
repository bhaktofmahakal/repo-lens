...
- "Create ABOUTME.md with personal details and profile links."
- "Create AI_NOTES.md describing AI usage and manual verification."
- "Record development prompts only in PROMPTS_USED.md; do not include responses, secrets, or API keys."
